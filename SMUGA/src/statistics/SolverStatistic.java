...
import statistics.elements.BestFindEvaluations;
import statistics.elements.BestValue;
import statistics.elements.NumberOfIndividuals;
import statistics.elements.SizeOfBB;
...
public class SolverStatistic implements Serializable {
    ...
    static {
        model.addStatistic(new BestValue());
        model.addStatistic(new SucessRate());
        model.addStatistic(new BestFindEvaluations());
        model.addStatistic(new SizeOfBB());
