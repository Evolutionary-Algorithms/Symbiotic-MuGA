...
public abstract class Knapsack extends Individual {
    ...
    public boolean isBest() {
        return isViable() && Knapsack.valueSack(this.getStringBits()) >= getBest();
    }

    public boolean isViable() {
        return Knapsack.heightSack(this.getStringBits()) <= capacity;
    }
...
//----------------------------------------------------------------------------------
    ...
    public double heightSack() {
        return heightSack(this.getStringBits());
    }
...
//    }
    ...
    public String toStringPhenotype() {
        double val = valueSack(this.getStringBits());
        double height = heightSack(this.getStringBits());
