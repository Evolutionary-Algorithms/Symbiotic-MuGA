 ...
 * @author manso
 */
public class TestRecombination extends javax.swing.JFrame {
    ...
    XYPlot plot;
    Recombination crossover = new Default();
    SimpleSolver solver = new Genetic_Algorithm();

    /**
     * Creates new form TestRecombination
     */
    public TestRecombination() {
        initComponents();
        ...
        loadJar("operator.recombination.real", lstCrossover);
        crossover = (Recombination) DynamicLoad.makeObject("operator.recombination.real." + lstCrossover.getSelectedValue().toString());
...
//            }
    ...
    private void lstCrossoverMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstCrossoverMouseClicked
        String cross = "operator.recombination.real." + lstCrossover.getSelectedValue().toString();
        crossover = (Recombination) DynamicLoad.makeObject(cross);
        crossover.setSolver(solver);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TestRecombination().setVisible(true);
            }
        });
    }
