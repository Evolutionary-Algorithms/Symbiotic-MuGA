...
public class PanelOfPopulation extends javax.swing.JFrame {
    ...
    private SimpleSolver solver = new Genetic_Algorithm();
    ...
    public void displayPopulation(Population pop, SimpleSolver solver) {
        ...
        if (tbPopulation.getSelectedComponent() == tbTxtGenotype) {
            if (solver instanceof Symbiosis) {
                Symbiosis ss = (Symbiosis) solver;
                txtGeno.setText(ss.parents.toSortedStringGenotype()
                        + "\n\n" + ss.getParasites().toSortedStringGenotype());
        ...
        if (tbPopulation.getSelectedComponent() == tbTxtPhenotype) {
            if (solver instanceof Symbiosis) {
                Symbiosis ss = (Symbiosis) solver;
                txtPheno.setText(ss.parents.toSortedStringPhenotype()
                        + "\n\n" + ss.getParasites().toSortedStringPhenotype());
