...
//        mut = (FlipBits) solver.getMutate();
        ...
        // 1.0 / #bits
        mut.setProbability(1.0 / pop.getGenotype(0).getStringBits().getNumberOfBits());
        ...
        while (oldPop.getNumGenotypes() > 1) {
            ...
            // crowding for c1
            double m1 = c1.getStringBits().getHammingDistance(p1.getStringBits())
                    + c2.getStringBits().getHammingDistance(p2.getStringBits());
            double m2 = c1.getStringBits().getHammingDistance(p2.getStringBits())
                    + c2.getStringBits().getHammingDistance(p1.getStringBits());
            if (m1 < m2) {
                //p1 c1
