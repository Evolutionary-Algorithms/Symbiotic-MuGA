 ...
 * @author manso
 */
public class M_SwapGenes extends  MutationPRM {
    ...
    public Population execute(Population pop) {
        ...
        while(it.hasNext()){
            PRM_Individual ind = (PRM_Individual)it.next();
 ...
 /**
    ...
    @Override
     public void doMutation(Individual ind) {
        ...
        double mutProb = probability == 0 ?
        (double)ind.getNumCopies() / (double)ind.getNumGenes():
                probability * ind.getNumCopies(); 
        mutate((PRM_Individual)ind, probability);
    }
