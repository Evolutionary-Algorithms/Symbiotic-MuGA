...
/**
 * http://www.dmi.unict.it/mpavone/nc-cs/materiale/moscato89.pdf On Genetic
 * Crossover Operators for Relative Order Preservation Pablo Moscato
 *
 * @author ZULU
 */
public class OX extends CrossoverPRM {
    ...
    public void doCrossover(Individual i1, Individual i2) {
        doCrossover((PRM_Individual) i1, (PRM_Individual) i2);
    }
...
//        cut1 =3;
//        cut2 = 6;
        Debug.println("X CUTS " + cut1 + " " + cut2);
...
//        int[] p2 = {4, 5, 2, 1, 8, 7, 6, 9, 3};
        //http://www.dmi.unict.it/mpavone/nc-cs/materiale/moscato89.pdf
        int[] p1 = {9, 8, 4, 5, 6, 7, 1, 3, 2, 0};
        int[] p2 = {8, 7, 1, 2, 3, 0, 9, 5, 4, 6};
