 ...
 * @author ZULU
 */
public class Estimation_Distibuition_Algorithm extends SimpleSolver {
...
//        System.out.print("\nED : ");
    ...
    public Population evolve(Population original) {
        ...
        //------------------ generate new Pop ----------------------------------
        //----------------------------------------------------------------------
        offspring = original.getCleanCopie();
        while (offspring.size() < sizePOP) {
            //-----------------------------------
            ...
            int copies = 1;
            if (offspring.contains(edi)) {
                copies = offspring.getGenotype(edi).getNumCopies();
            }
...
//        txt.append("\nStatistics    " + this.stats.getInfo().trim());
    ...
    public static void main(String[] args) {
        Estimation_Distibuition_Algorithm eda = new Estimation_Distibuition_Algorithm();
