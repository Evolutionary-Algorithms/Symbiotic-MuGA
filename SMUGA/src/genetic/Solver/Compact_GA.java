 ...
 * @author ZULU
 */
public class Compact_GA extends SimpleSolver {
    ...
    public Population evolve(Population original) {
        ...
        offspring = new SimplePopulation();
        //----------------------------------------------------------------------
        while (offspring.size() < sizePOP) {
            ...
            offspring.addGenotype(winner);
        }
        parents = offspring.getClone();
        return parents;
    }

    public String getAlgorithm() {
        StringBuilder str = new StringBuilder();
        str.append("\n Compact Genetic Algirthm Solver");
