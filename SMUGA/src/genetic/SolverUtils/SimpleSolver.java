...
public abstract class SimpleSolver implements Serializable {
    ...
    public static int DEFAULT_POPULATION_SIZE = 32;
    //------------------------------------------------------
    //------------------------------------------------------
    ...
    public Population offspring;//offspring population
    ...
    public final void setAll(SimpleSolver solver) {
        ...
        offspring = solver.offspring.getClone();
    ...
    public void restartSolver() {
        ...
        this.offspring = parents.getCleanCopie();
